function [t,y, varargout] = odewrap(solver, fun, nemflag, tspan, y0, options, varargin)
...
sz = size(y0);%[nz nx nbsv]
odefun = @(t,y) newfun(t, y, fun, nemflag, sz, varargin{:});
...
if nextraout > 0
    ...
    for it = 1:nt
        ...
        [extraout{it,:}] = fun(nemflag,t(it), yslice, varargin{:});
    end
...
function dydt = newfun(t, y, fun, nemflag, sz, varargin)
y = reshape(y, sz);
dydt = feval(fun, nemflag, t, y, varargin{:});
dydt = dydt(:);
