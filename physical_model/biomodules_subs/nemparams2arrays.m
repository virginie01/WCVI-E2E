...
%
%       RNo3PON:        scalar. stoichiometric coefficient No3:NH3 used for 
%                       denitrification
% 
...
%
%       vdec:           nbsvxnbsv array, decomposition rate of i into j @0degC (/s)
%
%       Nit0:           scalar, nitrification rate @0 deg (/s)
%
%       Kdec:           nbsvxnbsv array, temperature coefficient for
%                       decomposition (/degC) 
%
%       Knit:           scalar, temperature coefficient for nitrification
%                       (/degC)
%
...
%                       of PON). 
%
%       I0:             scalar, treshold for light inhibition 
%                       of nitrification (W.m-2)
%
%       KI:             scalar, light intensity at which the
%                       inhibition of nitrification is half-saturated (W.m-2)
%
%       alpha02:        scalar, slope of the delimiter f02 at
%                       02=0. f02 is used to calculate ammonification and
%                       denitrification rates. Kg.mol-1
%
%       alphaNo3:       scalar, slope of the delimiter fNo3 at
%                       No3=0. fNo3 is used to calculate ammonification and
%                       denitrification rates. Kg.mol-1 
%
...
%                       denitrification rates. Kg.mol-1 
%
%       alphaH2S:       scalar, slope of the delimiter fH2S at
%                       H2S=0. fH2S is used to calculate ammonification and
%                       denitrification rates. Kg.mol-1 
%
%      
%
...
B.KI=A.KI;
B.alphao2=A.alphao2;
B.alphaNo3=A.alphaNo3;
B.alphaNH4=A.alphaNH4;
B.alphaH2S=A.alphaH2S;
B.Nit0=A.Nit0;
B.Knit=A.KNit;
