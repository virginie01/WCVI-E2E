function [y, dy, Splits, Diag, failflag] = ode4splitsnonneg(odefun,tspan,y0,varargin)
%ODE4SPLITSNONNEG Like ode4, but returns intermediate components, no negative
%
% [y, dy, Splits, Diag, failflag] = ode4splitsnonneg(odefun,tspan,y0,G,P,B,p1,p2, ...)
%
...
% try
f0 = feval(odefun,tspan(1),y0,varargin{:});% nz x nx x nbsv final rate of change
% catch
