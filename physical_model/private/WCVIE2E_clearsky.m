function Qo = WCVIE2E_clearsky(start_date,t,Lat)
...
% Input variables:
%
%   start_date: 1 x 3 date vector of time corresponding to t = 0
%
%   t:          vector of time values to calculate clear-sky irradiance
%               for, in days since start_date 
%
...
tyear = datenum(start_date) + t - ...
        datenum([start_date(1) 1 1]);
