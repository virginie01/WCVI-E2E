function newtracer = WCVIE2E_verticalflux(tracer, wsink, dt, dz, openbot)
...
% Input variables:
%
%   tracer:     nz x nx array, concentration of tracer
%
%   wsink:      nz x nx 1 array, vertical velocities (m/s)
%
%   dt:         scalar, model time step (s)
%
%   dz:         nz x nx array, depth interval (m)
%
%   openbot:    logical scalar, true if open bottom (i.e. things sink out)
%
% Output variables:
%
%   newtracer:  nz x nx array, new value of tracer concentrations after one
%               time step 
